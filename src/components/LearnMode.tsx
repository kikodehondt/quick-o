...
export default function LearnMode({ set, settings: initialSettings, onEnd }: LearnModeProps) {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    const correct = checkAnswer(userAnswer, currentWord.word2, settings.caseSensitive, settings.accentSensitive)
  ...
  return (
    <div className="min-h-screen flex flex-col p-4 md:p-8 relative overflow-hidden" style={{background: 'linear-gradient(-45deg, #10b981 0%, #059669 25%, #047857 50%, #065f46 75%, #10b981 100%)', backgroundSize: '400% 400%', animation: 'gradientShift 20s ease infinite, learnModeEnter 0.6s ease-out'}}>
      <style>{`
        @keyframes learnModeEnter {
        ...
        <div className="flex-1 flex items-center justify-center mb-8">
          <div className="bg-white rounded-3xl p-12 card-shadow w-full max-w-2xl">
            <div className="text-center mb-8">
              ...
              <p className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">{currentWord.word1}</p>
              {!showFeedback && (
