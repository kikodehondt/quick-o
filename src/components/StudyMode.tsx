...
import { VocabSet, WordPair, supabase } from '../lib/supabase'
...
export default function StudyMode({ set, onEnd }: StudyModeProps) {
          ...
          >
            <div className="text-center">
              <p className="text-sm font-semibold text-gray-500 mb-4 uppercase tracking-wide">
                {showAnswer ? 'Frans' : 'Nederlands'}
              </p>
              <p className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
                {showAnswer ? currentWord.french : currentWord.dutch}
              </p>
              {!showAnswer && (
