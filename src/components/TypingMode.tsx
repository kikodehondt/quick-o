...
export default function TypingMode({ set, settings, onEnd }: TypingModeProps) {
  ...
  function getHint() {
    const currentWord = words[currentIndex]
    const answer = currentWord.word_2
                  ...
                  {userAnswer.length > 0 && !showFeedback && (
                    <div className="mb-4">
                      <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                        <div
                          className={`h-full transition-all duration-300 ${similarity > 70 ? 'bg-green-500' : similarity > 40 ? 'bg-yellow-500' : 'bg-red-500'
                            }`}
                  ...
                  <div className={`p-6 rounded-2xl bg-red-50 border-2 border-red-200`}>
                    ...
                    <div className="space-y-2">
                      ...
                      <div>
                        ...
                        <p className="text-xl font-semibold text-green-600">{currentWord.word_2}</p>
                      </div>
                    </div>
                  </div>
