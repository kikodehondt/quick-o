...
export function Timeline({ data }: { data: TimelineEntry[] }) {
  ...
  return (
    <div className="w-full bg-white font-sans" ref={containerRef}>
      <div className="max-w-6xl mx-auto py-6 px-2 md:px-8 lg:px-10">
        <h2 className="text-xl md:text-3xl mb-2 text-black">Changelog</h2>
        <p className="text-neutral-700 text-sm md:text-base max-w-prose">
          Overzicht van alle versies en verbeteringen.
        </p>
      </div>

      <div ref={markerRef} className="relative max-w-6xl mx-auto pb-12">
        {data.map((item, index) => (
