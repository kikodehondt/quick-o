            ...
            {editMode === 'name' && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-green-500 focus:ring-1 focus:ring-green-500 focus:outline-none text-sm"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-2 pr-10 rounded-lg border border-gray-300 focus:border-green-500 focus:ring-1 focus:ring-green-500 focus:outline-none text-sm"
                    placeholder="••••••••"
                    autoFocus
                    minLength={8}
                    disabled={loading}
